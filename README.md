...
2. 通过Web Search研究汇报单位的公开信息、AI与智能化战略及高管发言。
...
Skill会进行简短的能力介绍，并提示按照以下顺序使用：

1. 先提供产品、解决方案、案例或历史汇报资料，也可以指定知识库和在线文档。
2. 完成产品及解决方案知识整理，确认能力边界和可复用证据。
3. 补充客户或项目背景、汇报对象及期望推动的决策。
4. 必要时研究汇报单位的公开战略、高管观点及AI、智能化信息。
5. 在知识和情报基础上规划框架与逐页材料，而不是套用通用模板。
